...
export const replyKeyboards = {
  ...
  [UserState.ChoosingFollowingEntity]: new Keyboard().text("Отмена").resized(),
  [UserState.AskingWeekTeacher]: new Keyboard().text("Отмена").resized(),
  [UserState.AskingWeekGroup]: new Keyboard().text("Отмена").resized(),
